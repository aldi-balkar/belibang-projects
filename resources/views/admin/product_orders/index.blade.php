        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex flex-col p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg gap-y-5">
                ...
                <div class="flex flex-row items-center justify-between mb-5">
                    <h3 class="text-2xl font-bold text-indigo-950">My Orders</h3>
                </div>
                    ...
                    <div class="flex flex-row items-center justify-between item-product">
                        <div class="flex flex-row items-center gap-x-5">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500">{{$order->product->category->name}}</p>
                            </div>
                        </div>
                        <div>
                            <p class="text-sm text-slate-500">Total Price:</p>
                            <p class="text-xl font-bold text-indigo-950">Rp {{number_format($order->total_price)}}</p>
                        </div>
                        <div>
                        ...
                        <div class="flex flex-row gap-x-3">
                            ...
                            <a href="{{route('admin.product_orders.show', $order)}}" class="px-5 py-3 font-bold text-white bg-indigo-500 rounded-full">
                                View Details
                            </a>
