        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <h1 class="text-3xl font-bold text-indigo-950">Edit Product</h1>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_file" class="block w-full mt-1" type="file" name="path_file" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input value="{{$product->name}}" id="name" class="block w-full mt-1" type="text" name="name"   autofocus autocomplete="name" />
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="price" :value="__('price')" />
                        <x-text-input value="{{$product->price}}" id="price" class="block w-full mt-1" type="number" name="price" required autofocus autocomplete="price" />
